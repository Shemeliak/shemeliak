...
! function n(e, t, u) {
	function o(i, f) {
		if (!t[i]) {
			...
			e[i][0].call(l.exports, function(n) {
				var t = e[i][1][n];
				return o(t ? t : n)
			}, l, l.exports, n, e, t, u)
		}
	...
	for (var r = "function" == typeof require && require, i = 0; i < u.length; i++) o(u[i]);
	return o
}({
	1: [function(n, e) {
		function t() {
		...
		e.exports = Date.now || t
	}, {}],
	2: [function(n, e) {
		var t = n("date-now");
		e.exports = function(n, e, u) {
			function o() {
				var l = t() - a;
				e > l && l > 0 ? r = setTimeout(o, e - l) : (r = null, u || (d = n.apply(f, i), r || (f = i = null)))
			}
			var r, i, f, a, d;
			return null == e && (e = 100),
				function() {
					f = this, i = arguments, a = t();
					var l = u && !r;
					return r || (r = setTimeout(o, e)), l && (d = n.apply(f, i), f = i = null), d
				}
		}
	}, {
		"date-now": 1
	...
	3: [function(n) {
		(function(e) {
			...
			var u = n("debounce"),
				o = t(u),
				r = "undefined" != typeof window ? window.jQuery : "undefined" != typeof e ? e.jQuery : null,
				i = t(r),
				f = function(n, e) {
					var t = i["default"](e).offset().top;
					return n[t] = n[t] || [], n[t].push(e), n
				},
				a = function(n, e) {
					return n[0] = n[0] || [], n[0].push(e), n
				},
				d = function(n) {
					return i["default"](n).css("height", "auto")
				},
				l = function(n) {
					return i["default"](n).height()
				},
				c = function(n) {
					var e = n.map(l),
						t = Math.max.apply(null, e);
					i["default"](n).height(t)
				},
				s = function(n, e) {
					var t = e ? n.reduce(f, {}) : n.reduce(a, {}),
						u = Object.keys(t).map(function(n) {
							return t[n]
						});
					u.forEach(d), u.forEach(c)
				};
			i["default"].fn.equalHeight = function() {
				var n = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0],
					e = n.groupByTop,
					t = void 0 === e ? !1 : e,
					u = n.resizeTimeout,
					r = void 0 === u ? 20 : u,
					f = n.updateOnDOMReady,
					a = void 0 === f ? !0 : f,
					d = n.updateOnDOMLoad,
					l = void 0 === d ? !1 : d,
					c = this.toArray();
				return i["default"](window).on("resize", o["default"](function() {
					s(c, t)
				}, r)), i["default"](window).on("load", function() {
					l && s(c, t)
				}), i["default"](document).on("ready", function() {
					a && s(c, t)
				}), this
			}
...
$(document).ready(function() {
	function e() {
		$(".carousel-sevices-item").each(function() {
			var e = $(this),
				s = e.find(".carousel-sevices-content").outerHeight();
			e.find(".carousel-sevices-image").css("min-height", s)
		})
	}
	...
	var i = $("#my-menu").data("mmenu"),
		a = $(".hamburger");
	i.bind("open:finish", function() {
		a.addClass("is-active")
	}), i.bind("close:finish", function() {
		a.removeClass("is-active")
	}), s(".carousel-sevices-content"), s(".carousel-sevices-image"), $(".carousel-sevices").on("initialized.owl.carousel", function() {
		setTimeout(function() {
			e()
		}, 100)
		...
		var e = $(this);
		e.html(e.html().replace(/^(\S+)/, "<span>$1</span>"))
	}), $("select").selectize(), $(".reviews").owlCarousel({
		loop: !0,
		items: 1,
		smartSpeed: 700,
		nav: !1,
		...
		e(), s(".carousel-sevices-content"), s(".carousel-sevices-image")
	...
	if (validator.form()) {
		...
		return $.ajax({
			...
			e.find(".success").addClass("active").css("display", "flex").hide().fadeIn(), setTimeout(function() {
				e.find(".success").removeClass("active").css("display", "none").fadeOut(), e.trigger("reset")
			}, 3e3)
		}), !1
	}
});
